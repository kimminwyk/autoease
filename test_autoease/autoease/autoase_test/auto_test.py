...
#####
test_mysql_connect = db_auto(mysql_host="you mysql host",mysql_port="you mysql port",mysql_user="you mysql user",mysql_passwd="you mysql passwd",type_decision="dict")
